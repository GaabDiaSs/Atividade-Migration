...
CREATE TABLE `produtos` (
  ...
  `preco_venda` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estoque_minimo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estoque_maximo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `produto_detalhes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `comprimento` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `largura` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `altura` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
